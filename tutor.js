...
async function renderStudentDatabase(container, tutor) {
    ...
    async function editStudentDetails(studentId) {
        ...
        // Get current student data to pre-fill the prompts
        ...
        const newStudentName = prompt("Enter new student name:", currentData.studentName);
        const newGrade = prompt("Enter new grade:", currentData.grade);

        if (newStudentName !== null && newGrade !== null) {
            try {
                ...
                // Re-render the database to show the changes
                renderStudentDatabase(document.getElementById('mainContent'), window.tutorData);
            } catch (error) {
                console.error("Error updating document: ", error);
                showCustomAlert("Failed to update student details. See console for details.");
            }
        }
    }
    ...
    async function deleteStudent(studentId) {
        if (confirm("Are you sure you want to delete this student? This action cannot be undone.")) {
            try {
                ...
                // Re-render the database to remove the deleted student
                renderStudentDatabase(document.getElementById('mainContent'), window.tutorData);
            } catch (error) {
                console.error("Error removing document: ", error);
                showCustomAlert("Failed to delete student. See console for details.");
            }
        }
    }
