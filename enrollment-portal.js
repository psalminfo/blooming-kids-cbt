...
class EnrollmentApp {
    ...
    _showPasswordModal(portalResult) {
        ...
        try {
            const stored = JSON.parse(localStorage.getItem('bkh_new_parent') || '{}');
    ...
    async setupParentPortal(enrollmentData) {
        ...
        try {
            ...
            if (methods.length > 0) {
                ...
                // Store credentials in localStorage so parent.html can sign them in on load (works across tabs)
